...
function G_init{TR<:Real}(D::TR,τ::TR)
...
function get_policy{TR<:Real}(G0, D::TR, τ::TR, tol=1e-8, maxiter=1000, err=1, i=0)
    G       = G0    # Initial guess
...
function get_bonds{TR<:Real}(Z,G::AbstractArray,D::TR,τ::TR,c1,c2,c3,init=b_grid[1])
