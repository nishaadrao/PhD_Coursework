...
\end{align*}
Since this FOC holds for all varieties, for any pair of varieties $i, j$ we have
\begin{align*}
...
\end{align}
Thus, the optimal price features a markup over the marginal cost, and it is decreasing in the number of firms. This differs from the CES case, in which the optimal price features a constant markup over marginal costs (and does not depend on the number of firms).\\
...
To do so, I follow Alvarez and Lucas (2006) and make the normalization $\sum_{i=1}^N w_iL_i = 1$.
