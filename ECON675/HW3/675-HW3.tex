...
and
\begin{align*}
\Sigma_0 = \frac{\pi^2}{3} \E[(1-\mu(\mtx{x}'_i\mtx{\beta}_0))^2 \mu(\mtx{x}'_i\mtx{\beta}_0)^2 \mtx{x}_i\mtx{x}_i']
\end{align*}
Thus, the asymptotic variance collapses to
\begin{align*}
\mtx{V}_0 = \frac{\pi^2}{3}\E[(1-\mu(\mtx{x}'_i\mtx{\beta}_0))^2 \mu(\mtx{x}'_i\mtx{\beta}_0)^2 \mtx{x}_i\mtx{x}_i']^{-1}.
\end{align*}

\subsection{Logistic link function, MLE}
Yes, MLE gives the same results as above (this must be the case because MLE is asymptotically efficient).
